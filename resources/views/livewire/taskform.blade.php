    <div class="h-full w-full absolute top-0 left-0 justify-center items-center align-middle bg-[#20212166] hidden" id="full-bg" >
        ...
        <div class="h-fit w-[30em] p-5 flex flex-col rounded-md bg-[#ffffff] dark:bg-[#201f21] tabindex=-1">
          ...
          <span class="h-[2em] w-[2em] rounded-4xl p-1 flex items-center align-middle justify-center overflow-hidden self-end close-task-form"><i class="fa-solid fa-xmark w-full text-[#8f1bb5] rounded-4xl hover:text-[#e61d19] hover:bg-[#69696955] flex self-center text-center text-[1em] p-1 " id=""></i></span>
          <form wire:submit.prevent = "submit" class="flex flex-col gap-5">
            ...
            <div class="flex flex-col align-middle gap-2">
              ...
              <textarea name="description" wire:model='description' placeholder="Enter Note Here..." id="" class="h-[10em] w-full  rounded-sm dark:text-[#f3edf5] outline-[#8f1bb5] border-1 border-solid-[#8f1bb5] p-4 font-semibold resize-none" ></textarea>
            </div>
