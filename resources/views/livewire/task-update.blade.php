    <div class="h-full w-full absolute top-0 left-0 justify-center items-center align-middle bg-[#20212166] hidden" id="update-form" >
        ...
        <div class="h-fit w-[30em] p-5 flex flex-col rounded-md bg-[#ffffff] dark:bg-[#201f21] tabindex=-1">
            ...
            <label for="" class="font-bold dark:text-[#f3edf5]">TITLE: {{$task->title}}</label>
