    <div class="h-full w-full absolute top-0 left-0 justify-center items-center align-middle bg-[#20212166] hidden" wire:ignore.self id="update-form" >
        ...
        <div class="h-fit w-[30em] p-5 flex flex-col rounded-md bg-[#ffffff] dark:bg-[#201f21] tabindex=-1">
            ...
            @csrf
                @if ($tasks)
            <h1 class="font-bold dark:text-[#f3edf5]">UPDATE TASK</h1>
            <hr class="dark:text-[#f3edf5]">
            <div class="flex items-center align-middle gap-2 ">
            <label for="" class="font-bold dark:text-[#f3edf5]">TITLE:
            </label>
            <input type="text" name="title" wire:model='title' placeholder="Enter Title Here..." id="" class="h-[2em] w-full rounded-sm dark:text-[#f3edf5] outline-[#8f1bb5] border-1 border-solid-[#8f1bb5] p-4 font-semibold" required >
            </div>
            
            <div class="flex flex-col align-middle gap-2">
            <label for="" class="font-bold dark:text-[#f3edf5]">DESCRITPION:</label>
            <textarea name="description" wire:model='description' id="" class="h-[10em] w-full rounded-sm dark:text-[#f3edf5] outline-[#8f1bb5] border-1 border-solid-[#8f1bb5] p-4 font-semibold resize-none" placeholder="Enter Note Here..." ></textarea>
            </div>
            ...
            <input type="submit" value="UPDATE" class="font-bold bg-[#8f1bb5] hover:bg-[#6a198c] p-4 rounded-sm text-[#ffffff]">
                @endif
        </form>
        </div>
